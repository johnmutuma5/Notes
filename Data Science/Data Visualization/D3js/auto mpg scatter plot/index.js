...
const [dataX, dataY] = ['weight', 'horsepower']
...
const sanitizeData = (data) => {
  data.forEach(row => numericAutoAttrs.forEach(attr => row[attr] = +row[attr]));
  return data;
}
// render chart
const renderChart = async () => {
  const rawData = await getCsv('auto_mpg.csv');
  console.log(rawData)
